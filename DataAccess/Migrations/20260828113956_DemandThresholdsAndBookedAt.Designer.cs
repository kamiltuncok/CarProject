...
namespace DataAccess.Migrations
{
    ...
    [Migration("20260828113956_DemandThresholdsAndBookedAt")]
    partial class DemandThresholdsAndBookedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Concrete.PriceDecision", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsControlGroup")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("RealizedRentals")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CarId", "DecidedAt")
                        .HasDatabaseName("IX_PriceDecisions_CarHistory");

                    b.HasIndex("IsSettled", "DecidedAt")
                        .HasDatabaseName("IX_PriceDecisions_Settlement");

                    b.ToTable("PriceDecisions", (string)null);
                });
            ...
            modelBuilder.Entity("Entities.Concrete.Segment", b =>
                {
                    ...
                    b.Property<double>("HighDemandThreshold")
                        .HasColumnType("float");

                    b.Property<double>("LowDemandThreshold")
                        .HasColumnType("float");

                    b.Property<decimal>("MaxDailyPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("MinDailyPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
